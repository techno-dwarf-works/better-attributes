...
namespace Better.Attributes.EditorAddons.Drawers.Preview
{
    public abstract class PreviewHandler : SerializedPropertyHandler
    {
        ...
        public bool __ValidateObject(SerializedProperty property, ElementsContainer container)
        {
            ...
            _isValid = __ValidateObject(property.objectReferenceValue, container);
            return _isValid;
        }

        protected virtual bool __ValidateObject(Object drawnObject, ElementsContainer container)
        {
