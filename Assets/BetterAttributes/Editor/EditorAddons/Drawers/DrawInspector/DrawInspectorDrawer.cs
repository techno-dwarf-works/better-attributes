...
namespace Better.Attributes.EditorAddons.Drawers.DrawInspector
{
    ...
    public class DrawInspectorDrawer : BasePropertyDrawer<DrawInspectorHandler>
    {
        ...
        protected override void PopulateContainer(ElementsContainer container)
        {
            ...
            if (!__DrawInspectorUtility.Instance.IsSupported(fieldType))
            {
            ...
            var cache = ValidateCachedProperties(property, __DrawInspectorUtility.Instance);
